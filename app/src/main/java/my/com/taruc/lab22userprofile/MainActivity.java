...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String USER_ID = "my.edu.tarc.lab2.2userprofile.ID";
    public static final String USER_EMAIL = "my.edu.tarc.lab2.2userprofile.EMAIL";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewID = (TextView)findViewById(R.id.idtxt);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        //date = the data returned from an intent
        ...
        if(requestCode == REQUEST_PROFILE_UPDATE){
            ...
            //Display data on UI
            textViewID.setText(getString(R.string.getID)+ ":" +id);
            textViewEmail.setText(getString(R.string.displayemail)+":"+ email);
        }
